...
1. Loads documents from:
   ...
   - `../personalwebsite/blog/posts/` - Markdown blog posts with frontmatter
...
../personalwebsite/blog/posts/            # Blog posts (outside python-rag)
...
- Check that `../personalwebsite/blog/posts/` exists
